...
const Form = (imgsrc) => {
  ...
  return (
    <div className="flex">
      <form className="container flex-1 bg-blue-500 bg-opacity-20 my-12 mx-auto p-8 lg:w-8/12 rounded-lg border-2 z-50">
        ...
        <div className="relative z-0 mb-6 w-full group text-purple-300">
          Event Description
          <div className="text-purple-300 relative bg-[rgb(116,104,126)] bg-opacity-40 flex-col mt-4 rounded-lg py-4 px-8">
            <div className="relative z-0 mb-6 w-full group">
              <input
                type="text"
