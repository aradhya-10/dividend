  ...
  return (
    <>
      ...
      <div className="flex dark:bg-black">
        <form className="container bg-blue-400 bg-opacity-30 my-12 mx-auto p-8 max-w-[800px] rounded-lg border-2 z-50">
          <div className="grid md:grid-cols-2 md:gap-6">
            <div className="flex justify-between z-0 mb-6 w-full group">
          ...
          <div className="relative z-0 mb-6 w-full group text-purple-300">
            Event Description
            <div className="text-purple-700 relative bg-[rgb(116,104,126)] flex-col mt-4 rounded-lg py-4 px-8">
              Metadata
